...
void InitRS485()
{
    uart_port_t uart_num = (uart_port_t) (CONFIG_ECHO_UART_PORT_NUM);
...
void Sensor::InitSensorTrigger()
{
    ...
    RS485Send((uart_port_t) CONFIG_ECHO_UART_PORT_NUM, sendSetTrigger, 6);
}
int Sensor::GetDistance()
{
    RS485Send((uart_port_t) CONFIG_ECHO_UART_PORT_NUM, sendDistance, (int)6);
    int len = RS485Receive((uart_port_t) CONFIG_ECHO_UART_PORT_NUM);
    return len;
}

int Sensor::GetTemp()
{
    RS485Send((uart_port_t) CONFIG_ECHO_UART_PORT_NUM, sendTemp, (int)6);
    int len = RS485Receive((uart_port_t) CONFIG_ECHO_UART_PORT_NUM);
    return len;
}
